...
sim_file_fida = 'mizoguchi1990_output_timestep_fida.nc'
...
ds_fida = xr.open_dataset( sim_path / sim_file_fida )
...
mLayerVolFracIce_fida = ds_fida.mLayerVolFracIce
mLayerVolFracLiq_fida = ds_fida.mLayerVolFracLiq
...
mLayerVolFracTot_fida = mLayerVolFracLiq_fida + mLayerVolFracIce_fida
...
mLayerVolFracTot_fida_t720  = mLayerVolFracTot_fida.isel(time=720)
mLayerVolFracTot_fida_t1440 = mLayerVolFracTot_fida.isel(time=1440)
mLayerVolFracTot_fida_t3000 = mLayerVolFracTot_fida.isel(time=3000)
