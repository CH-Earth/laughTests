...
sim_name_fida = "celia1990_output_timestep_fida.nc"
...
ds_fida = xr.open_dataset( sim_path / sim_name_fida )
...
matricHead_fida = ds_fida.mLayerMatricHead
...
matricHead_fida_t10 = matricHead_fida.isel(time=10)
matricHead_fida_t32 = matricHead_fida.isel(time=32)
matricHead_fida_t49 = matricHead_fida.isel(time=49)
